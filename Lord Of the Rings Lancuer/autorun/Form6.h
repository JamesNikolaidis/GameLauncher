...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(214, 24);
			this->textBox1->Multiline = true;
			this->textBox1->Name = L"textBox1";
			this->textBox1->ReadOnly = true;
			this->textBox1->Size = System::Drawing::Size(373, 76);
			this->textBox1->TabIndex = 1;
			this->textBox1->Text = L"If you want to continue the installation of the Game click on Next if you agree w" 
				L"ith the Directory for install the game ,else click on Browser and Change the Dir" 
				L"ectory";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(512, 226);
			...
			this->ClientSize = System::Drawing::Size(599, 261);
