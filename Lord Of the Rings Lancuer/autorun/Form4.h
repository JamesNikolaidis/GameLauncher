...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->pictureBox1->Size = System::Drawing::Size(234, 262);
			...
			this->label1->Size = System::Drawing::Size(430, 90);
			this->label1->TabIndex = 1;
			this->label1->Text = L"In this Form you must Click on the button Accept the terms of use to continue the" 
				L" installation, it is importan for us and for you to read the use terms very care" 
				L"fully.";
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(421, 190);
			...
			this->ClientSize = System::Drawing::Size(686, 261);
